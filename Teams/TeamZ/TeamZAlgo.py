...
class TeamZAlgo:
    ...
    def __init__(self):
        ...
        self.grid = [[]]
        self.came_from = []
        print("\n[TeamZAlgo]: Constructor TeamZAlgo successfully executed.")
    ...
    def loadMaze(self, pathToConfigFile):
        ...
        if exists:
            print("[TeamZAlgo]: SUCCESS loading file: ", pathToConfigFile)
        else:
            print("[TeamZAlgo]: ERROR loading file ", pathToConfigFile)
    ...
    def solveMaze(self):
        print("[TeamZAlgo]: start solving maze... ")
